...
if __name__ =="__main__":
    ...
    calibration_dir = (
            config.calibration_dir if config.calibration_dir else HF_LEROBOT_CALIBRATION / ROBOTS / "so101_follower"
    )
    calibration_dir.mkdir(parents=True, exist_ok=True)
    calibration_fpath = calibration_dir / f"{id}.json"
